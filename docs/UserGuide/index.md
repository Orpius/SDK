...
<!--TOC-->
  ...
  - [Using Operations to Connect Your Application to AI Agents](#using-operations-to-connect-your-application-to-ai-agents)
    ...
    - [Calling Operations from Chats, Events, Schedules, and other Operations](#calling-operations-from-chats-events-schedules-and-other-operations)
      ...
      - [Orchestrating Conversat](#orchestrating-conversat)
      - [n Continuity

Just like when chatting wi](#n-continuityjust-like-when-chatting-wi)
      - [lay Conceptual Flow](#lay-conceptual-flow)
      - [OperationRelay allows an Operation on one node t](#operationrelay-allows-an-operation-on-one-node-t)
  - [ide a secure and flexible way to conn](#ide-a-secure-and-flexible-way-to-conn)
    - [e an event in Orpius:](#e-an-event-in-orpius)
      - [s what events are, and can be i](#s-what-events-are-and-can-be-i)
    - [e steps:

1. **Register the E](#e-steps1.-register-the-e)
    - [nct ways:

1. **Exter](#nct-ways1.-exter)
    - [vities or follow-up events](#vities-or-follow-up-events)
      - [A camera sends a motion detected event. 
* You configure this event](#a-camera-sends-a-motion-detected-event.-you-configure-this-event)
    - [daptive rather than follow rigid workflows.](#daptive-rather-than-follow-rigid-workflows.)
    - [n pass additional parameters
that ar](#n-pass-additional-parametersthat-ar)
      - [xed with an underscore ( _ ) 
  are pa](#xed-with-an-underscore-_-are-pa)
      - [airs (apart from the **event-id**) are s](#airs-apart-from-the-event-id-are-s)
  - [**when** an activity should occur.
O](#when-an-activity-should-occur.o)
    - [Start a new **Chat**](#start-a-new-chat)
  - [rpius—whether triggered by an **event** or a **sched](#rpiuswhether-triggered-by-an-event-or-a-sched)
    - [generated by named events within a s](#generated-by-named-events-within-a-s)
    - [tracks progress, timeouts,](#tracks-progress-timeouts)
    - [are passed 
to the inter](#are-passed-to-the-inter)
  - [ed activity in Orpius performs as intended,](#ed-activity-in-orpius-performs-as-intended)
    - [cords the **original in](#cords-the-original-in)
    - [that AI-driven activities com](#that-ai-driven-activities-com)
    - [ur Orpius deployment** a](#ur-orpius-deployment-a)
    - [in Orpius](#in-orpius)
  - [area.

Files uploaded to isol](#area.files-uploaded-to-isol)
    - [the **Upload** butt](#the-upload-butt)
    - [ct the file(s) you wi](#ct-the-files-you-wi)
    - [ypes.
Common examples includ](#ypes.common-examples-includ)
  - [ultiple spaces, and each space can have](#ultiple-spaces-and-each-space-can-have)
    - [areness within the chat interface by asking, "Who is](#areness-within-the-chat-interface-by-asking-who-is)
    - [ies in non-interactive scenarios such as schedu](#ies-in-non-interactive-scenarios-such-as-schedu)
  - [* or **Owner** can invite](#-or-owner-can-invite)
    - [debar
2. Select the **'+ Add New](#debar2.-select-the-add-new)
    - [sole and select any Space (invitations are](#sole-and-select-any-space-invitations-are)
    - [e the following limits that control user acce](#e-the-following-limits-that-control-user-acce)
    - [rs can manage key configuration options and restrictions 
i](#rs-can-manage-key-configuration-options-and-restrictions-i)
  - [ith Orpius in your own environment.](#ith-orpius-in-your-own-environment.)
<!--/TOC-->
